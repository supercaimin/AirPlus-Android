package cn.homecaught.airplus.view;
...
public class ImageCycleView extends LinearLayout {
	 ...
	 */
	public void setNetWorkImageResources(ArrayList<String> imageUrlList, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
		...
		mAdvAdapter = new NetworkImageCycleAdapter(mContext, imageUrlList, imageCycleViewListener);
	 ...
	 * @param imageCycleViewListener
	 */
	public void setLocalImageResources(ArrayList<Integer> imageList, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
		mGroup.removeAllViews();
		// 图片广告数量
		...
		mAdvAdapter = new LocalImageCycleAdapter(mContext, imageList, imageCycleViewListener);
		mAdvPager.setAdapter(mAdvAdapter);
		startImageTimerTask();
	}
	/**
	...
	private class NetworkImageCycleAdapter extends PagerAdapter {
		...
		public NetworkImageCycleAdapter(Context context, ArrayList<String> adList, ImageCycleViewListener imageCycleViewListener) {
			mContext = context;
			mAdList = adList;
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			...
			mImageCycleViewListener.displayImageURL(imageUrl, imageView);
			return imageView;
		}
	...
	private class LocalImageCycleAdapter extends PagerAdapter {
		...
		public LocalImageCycleAdapter(Context context, ArrayList<Integer> adList, ImageCycleViewListener imageCycleViewListener) {
			mContext = context;
			mAdList = adList;
			mImageCycleViewListener = imageCycleViewListener;
			mImageViewCacheList = new ArrayList<ImageView>();
		...
		@Override
		public Object instantiateItem(ViewGroup container, final int position) {
			Integer resId = mAdList.get(position);
			ImageView imageView = null;
			if (mImageViewCacheList.isEmpty()) {
				imageView = new ImageView(mContext);
				imageView.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
			...
			container.addView(imageView);
			mImageCycleViewListener.displayImageResId(resId, imageView);
			return imageView;
		}
